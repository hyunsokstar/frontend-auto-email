        ...
        <Box bg={bg} color={color}>
            <Flex align="center" justify="space-between" p={4}>
                ...
                <Flex align="center" gap={2}>
                    <Box >
                        <Input placeholder="ID" variant="filled" size="sm" bg={inputBg} color={inputColor} _placeholder={inputPlaceholderStyle} />
                    </Box>
                    <Box>
                    ...
                    {/* <Button colorScheme="teal" size="sm" px="3">회원 가입</Button> */}
                    <SignUpModal />
